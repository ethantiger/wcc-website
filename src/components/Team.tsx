...
export default function About() {
  ...
  return (
    <section id="team" className="min-h-screen relative overflow-hidden py-12 md:py-0">
      {/* Gradient Background */}
      ...
      <div className="flex flex-col md:flex-row items-center justify-start text-gray-200 relative z-10 pt-36">

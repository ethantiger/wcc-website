...
export default function Carpool() {
  ...
  return (
    <div className="w-full">
      <div className="flex w-full flex-col gap-4 rounded-tl-3xl border border-slate-200/50 bg-white to-indigo-50/30 p-4 sm:p-6 md:p-8 lg:p-10 dark:border-slate-700/50 dark:bg-gray-900 shadow-xl min-h-screen">
